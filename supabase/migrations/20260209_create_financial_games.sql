...
('consultor', '{"text": "Investimento com retorno garantido de 10% ao mês. É uma oportunidade única ou golpe?", "type": "bad", "icon": "🚀", "explanation": "Golpe! Retornos garantidos muito acima do mercado (como 1% a.m.) geralmente são pirâmides financeiras."}', 'easy'),
('consultor', '{"text": "Pegar um empréstimo com juros de 8% ao mês para comprar roupas novas. Faz sentido?", "type": "bad", "icon": "💸", "explanation": "Juros abusivos! 8% ao mês vira mais de 150% ao ano. Nunca tome dívida cara para consumo."}', 'easy'),
('consultor', '{"text": "Aplicar a Reserva de Emergência no Tesouro Selic é uma boa opção?", "type": "good", "icon": "🛡️", "explanation": "Ótima escolha! O Tesouro Selic é seguro e tem liquidez diária, ideal para emergências."}', 'easy'),
('consultor', '{"text": "O mercado caiu hoje! Devo vender todas as minhas ações para evitar mais perdas?", "type": "bad", "icon": "📉", "explanation": "Pânico! Vender na baixa consolida o prejuízo. O ideal é analisar os fundamentos e pensar no longo prazo."}', 'easy'),
('consultor', '{"text": "Fazer aportes mensais em Fundos Imobiliários para gerar renda passiva. É uma boa estratégia?", "type": "good", "icon": "🏢", "explanation": "Excelente estratégia! A constância nos aportes e o reinvestimento dos dividendos criam uma bola de neve."}', 'easy'),
('consultor', '{"text": "Financiar um carro de luxo em 60x sem entrada é um bom negócio para o seu bolso?", "type": "bad", "icon": "🚗", "explanation": "Cuidado! O custo total será muito maior que o valor do carro, e o veículo desvaloriza rápido."}', 'medium'),
('consultor', '{"text": "Diversificar a carteira entre Renda Fixa e Renda Variável ajuda a reduzir riscos?", "type": "good", "icon": "🎨", "explanation": "Isso reduz riscos! Não colocar todos os ovos na mesma cesta protege seu patrimônio."}', 'medium'),
('consultor', '{"text": "O gerente ofereceu um Título de Capitalização. Devo aceitar para ajudar a guardar dinheiro?", "type": "bad", "icon": "🎟️", "explanation": "Péssimo negócio! Geralmente rende menos que a poupança e seu dinheiro fica preso. É um jogo, não investimento."}', 'medium'),
('consultor', '{"text": "Contratar um Seguro de Vida para proteger minha família. É um investimento em tranquilidade?", "type": "good", "icon": "👨‍👩‍👧‍👦", "explanation": "Responsável! Proteção financeira para dependentes é fundamental em um planejamento financeiro sólido."}', 'medium'),
('consultor', '{"text": "Usar minha Reserva de Emergência para aproveitar ações que estão em queda livre. Vale o risco?", "type": "bad", "icon": "🆘", "explanation": "Arriscado! A Reserva de Emergência deve ficar em liquidez imediata e baixo risco, não em renda variável."}', 'medium'),
('consultor', '{"text": "Reinvestir todos os dividendos que recebi de minhas ações e FIIs. É o caminho certo?", "type": "good", "icon": "🔄", "explanation": "O segredo da riqueza! Reinvestir cria o efeito de juros compostos, acelerando o crescimento do patrimônio."}', 'hard'),
('consultor', '{"text": "Comprar um imóvel na planta sem antes pesquisar o histórico da construtora. É seguro?", "type": "bad", "icon": "🏗️", "explanation": "Alto risco! A obra pode atrasar ou a construtora falir. Sempre pesquise o histórico antes."}', 'hard'),
('consultor', '{"text": "Recebi um aumento! Vou aproveitar para aumentar meu aporte mensal em vez de gastar mais. Boa ideia?", "type": "good", "icon": "📈", "explanation": "Mentalidade correta! Evite inflar seu custo de vida proporcionalmente. Invista a diferença."}', 'hard'),
('consultor', '{"text": "Pegar um empréstimo para investir tudo em uma criptomoeda nova. É assim que se fica rico rápido?", "type": "bad", "icon": "🪙", "explanation": "Perigo máximo! Alavancagem em ativos voláteis pode te deixar com dívidas impagáveis se o ativo cair."}', 'hard'),
('consultor', '{"text": "Estudar profundamente sobre uma empresa antes de comprar suas ações. É perda de tempo ou essencial?", "type": "good", "icon": "📖", "explanation": "Essencial! Investimento requer análise. Comprar \"dicas\" sem entender é receita para o fracasso."}', 'hard');
