  ...
  useEffect(() => {
    async function fetchRates() {
      ...
      if (data) {
        ...
        const newRates = {
          selic: data.find(d => d.ticker === 'SELIC')?.preco_atual || 11.25,
          cdi: data.find(d => d.ticker === 'CDI')?.preco_atual || 11.15,
          ipca: data.find(d => d.ticker === 'IPCA')?.preco_atual || 4.5,
          poupanca: data.find(d => d.ticker === 'POUPANCA')?.preco_atual || 6.17,
        };
        setRates(newRates);
      }
    }
